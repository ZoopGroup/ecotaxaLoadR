...
jobs <- list_jobs(for_admin = FALSE)
...
filters_reqs <- ProjectFilters()

# export parameters
export_reqs <- GeneralExportReq(
  project_id        = 5421,
  split_by          = "none",
...
export_request_body <- Body_export_object_set_general_object_set_export_general_post(
  filters = filters_reqs,
  request = export_reqs
)

# execute export request
export_object_set_general(export_request_body)
